...
# Camera warm-up time
sleep(2)
camera.capture('xmen.jpg')
camera.stop_preview()
"""
"""
"""
"""
ama=cv2.imread("hello.jpg")
...
p = subprocess.Popen(["tesseract", "--tessdata-dir", "/usr/share/tesseract-ocr", "image.jpg", "zorotext", "-l", "eng", "-psm", "3"], stdout=subprocess.PIPE)
